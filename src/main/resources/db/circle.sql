...
CREATE DATABASE IF NOT EXISTS `circle` DEFAULT CHARACTER SET utf8mb4;
USE `circle`;
...
CREATE TABLE `tb_seckill_voucher`  (
                                       ...
                                       `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                       `begin_time` timestamp NOT NULL DEFAULT '2023-05-03 21:52:11' COMMENT '生效时间',
                                       `end_time` timestamp NOT NULL DEFAULT '2023-05-03 22:52:11' COMMENT '失效时间',
                                       `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
